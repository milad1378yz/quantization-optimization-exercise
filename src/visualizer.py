...
def plot_original_vs_quantized(v, quantized_vector, title='Original vs. Quantized Vector'):
...
def plot_with_quantization_levels(v, quantization_levels, title='Original Vector with Quantization Levels'):
...
def plot_distribution(v, quantization_levels, title = 'Distribution of Original Vector and Quantization Levels'):
